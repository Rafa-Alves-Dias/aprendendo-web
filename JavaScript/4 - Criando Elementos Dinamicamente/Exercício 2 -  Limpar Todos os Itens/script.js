...
buttonDeleteAll.className = "btn-remover-tudo";
buttonDeleteAll.textContent = "Remover tudo";


document.querySelector(".container").appendChild(buttonDeleteAll);

function deletarLista(){
    listaCompras.innerHTML="";
    atualizarContador();
}
buttonDeleteAll.addEventListener("click", deletarLista);